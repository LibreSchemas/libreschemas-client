...
export const [initialState, setInitialState] = React.useState<
InitialState | undefined
>();

export const [theme, setTheme] = React.useState<ReactNativePaper.Theme>(
    CustomDefaultTheme
  );
...
export const preferences = React.useMemo(
    () => ({
      toggleTheme: () =>
        setTheme((theme) =>
